<?php
    ...
    if(isset($_POST['add'])){
		...
		$insertsql = "INSERT INTO apartmentsTable (
            apartmentbuildingname, 
            apartmentspecificaddress, 
            apartmenttype, 

            apartmenttenantunitarea, 
            apartmenttenantunitbedrooms, 
            apartmenttenantunitbeds, 
            apartmenttenantunitbathrooms, 

            apartmenttenantunitamenities1, 
            apartmenttenantunitamenities2, 
            apartmenttenantunitamenities3, 
            apartmenttenantunitamenities4, 
            apartmenttenantunitamenities5, 

            apartmentgarageavailability, 

            apartmentimage1, 
            apartmentimage2, 
            apartmentimage3, 

            apartmenttenantunitmonthlyrentprice, 
            apartmentcontactlandlord) VALUES (
                '$apartmentbuildingname', 
                '$apartmentspecificaddress', 
                '$apartmenttype', 
                ...
                '$apartmenttenantunitmonthlyrentprice', 
                '$apartmentcontactlandlord')";

        $query = mysqli_query($con, $insertsql);
        
        if($query){
            echo "<script type='text/javascript'>alert('Data Insertion Successful!')</script>";
		}else{
            ...
            <div class="row">
                <div class="col-md-12 col-lg-8">
                    <div class="title-single-box">
                        <h1 class="title-single">Add Listing</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Apartment Building Name" name="apartmentbuildingname">
                                        </div>
                                    </div>
                                
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Specific Address" name="apartmentspecificaddress">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-lg form-control-a" placeholder="Tenant Unit Area" name="apartmenttenantunitarea">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group">
                                            <label for="Amenities">Amenities</label>
                                                <input type="text" class="form-control form-control-lg form-control-a" placeholder="Amenities 1" name="apartmenttenantunitamenities1"><br>
                                                <input type="text" class="form-control form-control-lg form-control-a" placeholder="Amenities 2" name="apartmenttenantunitamenities2"><br>
                                                <input type="text" class="form-control form-control-lg form-control-a" placeholder="Amenities 3" name="apartmenttenantunitamenities3"><br>
                                                <input type="text" class="form-control form-control-lg form-control-a" placeholder="Amenities 4" name="apartmenttenantunitamenities4"><br>
                                                <input type="text" class="form-control form-control-lg form-control-a" placeholder="Amenities 5" name="apartmenttenantunitamenities5">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group">
                                            <label for="Images">Images</label>
                                                <input type="text" class="form-control form-control-lg form-control-a" placeholder=".jpg , .png" name="apartmentimage1"><br>
                                                <input type="text" class="form-control form-control-lg form-control-a" placeholder=".jpg , .png" name="apartmentimage2"><br>
                                                <input type="text" class="form-control form-control-lg form-control-a" placeholder=".jpg , .png" name="apartmentimage3">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        <div class="form-group">
                                            <label for="Price">Monthly Rent Price</label>
                                                <input type="text" class="form-control form-control-lg form-control-a" placeholder="Monthly Rent Price" name="apartmenttenantunitmonthlyrentprice">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-lg form-control-a" placeholder="+639" name="apartmentcontactlandlord">
                                        </div>
                                    </div>
                                
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-b" name="add">Submit Listing</button>
                                    </div>
